...
#create_byage_df() meruapakan helper fuction yang digunakan untuk menyiapkan byage_df()
...
#create_bystate_df() meruapakan helper fuction yang digunakan untuk menyiapkan bystate_df()
...
#create_rfm_df() bertanggung jawab untukmenghasilkan rfm_df
...
#load data all_date.csv sebagai dataframe
all_df = pd.read_csv("all_data.csv")

#Mengurutkan Dataframe berdasarkan oreder_date serta memastikan kedua kolom bertipe datatime
...
with st.sidebar:
    ...
    #Mengambil start_date dan end_date dari data_input
...
#Menyimpan start_date & end_date ke main_df
main_df = all_df[(all_df["order_date"] >= str(start_date)) & 
                 (all_df["order_date"] <= str(end_date))]

#Membuat visualisasi data dengan memanggil helper fuction yang dibuat sebelumnya
...
#Menambahkan informasi terkait daily_order pada Dashboard
...
#Menampilkan informasi penjualan setiap produk(5 produk paling laris & paling sedikit terjual melalui visualisasi data)
...
# tampilkan pada dashboard tersebut ialah terkait demografi pelanggan yang kita miliki
...
#Menampilkan parameter RFM (Recency, Frequency, & Monetary)dengan menampilkan nilai average atau rata-rata dari ketiga parameter tersebut menggunakan widget metric().
